              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="d-flex flex-wrap">
                  @foreach($permissions as $permission)
                      <div class="flex flex-col justify-center col-md-3">
                ...
                <div class="text-center mt-4">
                  <button type="submit" class="bg-blue border border-primary text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">Submit</button>
                </div>
              </div>
