        ...
        <div class="card-body">
            ...
            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control @error('address') is-invalid @enderror"
                           id="address"
                ...
                <div class="form-group">
                    <label for="address">Confirmation Password</label>
                ...
                <div class="d-flex">
                  @foreach($roles as $role)
                      <div class="flex flex-col justify-cente mr-3">
